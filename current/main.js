...
async function toolsCurrent() {
  ...
  const toolsVersMap = /* @__PURE__ */ new Map();
  ...
  let rawOut = "";
  for (const [tool, version2] of toolsVersMap) {
    core3.setOutput(tool, version2);
    rawOut += `${tool} ${version2}
`;
  }
